    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen font-display flex flex-col">
            ...
            <main className="flex-grow max-w-7xl mx-auto px-6 py-20">
                <h1 className="text-4xl font-bold mb-8">About Safe Surf AI</h1>
                <p className="text-lg text-slate-600 dark:text-slate-400">
                    Safe Surf AI is dedicated to making the internet a safer place for everyone.
                    Our advanced AI algorithms detect phishing attempts in real-time to protect your data and privacy.
                </p>
            </main>
        </div>
    );
